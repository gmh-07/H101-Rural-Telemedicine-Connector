...
const doctors = [
  { 
    ...
    description: "Specialist in digestive system disorders and liver care. Dr. Deshmukh has over 15 years of experience in treating complex gastrointestinal conditions, performing endoscopic procedures, and managing liver diseases. He is known for his patient-centric approach, detailed diagnosis, and advanced treatment methods.",
  ...
  { 
    ...
    description: "Orthopaedic surgeon specializing in joint replacement, fractures, spine injuries, and sports medicine. Dr. Sonegaonkar has successfully performed numerous surgeries and rehabilitation programs. His expertise ensures patients regain mobility, strength, and confidence with minimal recovery time.",
  ...
  { 
    ...
    description: "Heart specialist focusing on preventive cardiology, heart failure management, and interventional procedures such as angioplasty and stent placement. Dr. Tiwari is known for educating patients about heart health, managing high-risk cases, and saving lives with timely cardiac interventions.",
  ...
  return (
    <>
      ...
      <h4 className="leaderboard-h4">
        *This leaderboard is updated at the end of every month and the Best Doctor receives the prizes
      </h4>
      ...
      <div className="leaderboard-container">
        ...
        <div className="podium">
          ...
          <div className="podium-slot first">
            <img src={podium[0].img} alt={podium[0].name} className="avatar big" />
                ...
                >
                  ...
                  <td>
                    <div className="table-user">
                      <img src={doc.img} alt={doc.name} className="table-avatar" />
                      {doc.name}
                    </div>
                  </td>
                  <td>{doc.specialty}</td>
      ...
      {selectedDoctor && (
        <div className="modal-overlay" onClick={() => setSelectedDoctor(null)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <img src={selectedDoctor.img} alt={selectedDoctor.name} className="modal-avatar" />
